...
#The address depends on the cloud you are in, fill with collector-eu.devo.io for Europe and with collector-us.devo.io for the US',
'\ncon = Sender.from_config({"address": "fill me!", "port": 443, "key": "fill me!", "cert": "fill me!", "chain": "also...fill me!"})',
'\n#fill the tag with the appropiate Devo tag for the table you want to fill',
'\nfor index, row in result_table.iterrows():',
'\n    con.send(tag="fill me!", msg=row[i])')
```
