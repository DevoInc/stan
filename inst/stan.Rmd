...
message('alpha <- ', hwinters$alpha)
message('beta <- ', hwinters$beta)
message('gamma <- ', hwinters$gamma)
message('type <- ', t)
message('thresholdPercentile <- ', threshold)
message('thresholdConfInt <- ', std_res)
```
