...
`r if(period !=1) {'The code is generated in Python and ready to use. Data is extracted with the Devo SDK publicly available on Devo\'s GitHub account ([link here](https://github.com/DevoInc/python-sdk)). The user must only fill in the public and secret API keys.'}` 
...
message('#Doing smoothing and defining alerts',
