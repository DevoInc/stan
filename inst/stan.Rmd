...
It contains `r length(ts)` observations, going from `r as.POSIXct(data[1,1], origin="1970-01-01")` to `r as.POSIXct(data[length(data[,1]),1], origin="1970-01-01")`. 
