...
legend('topleft', legend = c('Time Series', 'Prediction','Detected Anomaly'), bty = "n", col = c('black', 'red', 'blue'), lty = c(1, 1, 0), pch = c(NA, NA, 19), inset = c(-0.05,-0.1), xpd = TRUE, horiz = TRUE)
...
legend('topleft', legend = c('Time Series', 'Prediction','Confidence Interval','Detected Anomaly'), bty = "n", col = c('black', 'red', 'blue', NA), lty = c(1, 1, NA, NA), pch = c(NA, NA, 19, NA), density=c(0,0,0,NA), fill = c('black', 'red', 'blue', 'grey'), border = c(NA,NA,NA,"grey"), inset = c(-0.2,-0.2), xpd = TRUE, horiz = FALSE)
