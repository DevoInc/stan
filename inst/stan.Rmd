...
legend('topleft', legend = c('True Series', 'Smoothing','Prediction Interval'), col = c('black', 'red', 'blue'), cex = 0.8, lty = 1)
...
```{r, echo=FALSE, eval=(period!=1)}
plot(as.vector(ts), main = 'Filtering with percentiles', type = 'l', xlab = 'Time', ylab = '')
lines(1:length(ts), pred, col = 'red')
points(which(residuals > threshold), ts[(residuals > threshold)], pch = 19, col = 'blue')
legend('topleft', legend = c('Time Series', 'Prediction','Detected Anomaly'), col = c('black', 'red', 'blue'), lty = c(1, 1, 0), pch = c(NA, NA, 19))
```
...
lines(1:length(ts), pred, col = 'red')
points(which(residuals > threshold), ts[(residuals > threshold)], pch = 19, col = 'blue')
legend('topleft', legend = c('Time Series', 'Prediction','Confidence Interval','Detected Anomaly'), bty = "n", col = c('black', 'red', 'blue', NA), lty = c(1, 1, NA, NA), pch = c(NA, NA, 19, NA), density=c(0,0,0,NA), fill = c('black', 'red', 'blue', 'grey'), border = c(NA,NA,NA,"grey"))
```
...
```{r, echo=FALSE, eval = (typ != 'both' & typ != 'null')}
#We build the json object that contains all parameters necessary to the subsequent study.
list1[['type']] <- typ
